  ...
  return (
    <div className='mt-12 container-center'>
      <div className='p-3 flex items-center justify-center'>
            <h2 className='font-semibold text-2xl capitalize md:text-3xl bg-linear-to-r from-primary to-secondry bg-clip-text text-transparent italia'>{title?.replace("-" , " ")}</h2>
      </div>
      <div>
