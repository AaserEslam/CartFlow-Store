        ...
        <SwiperSlide className="p-6 ">
          <div className="md:grid md:grid-cols-2 gap-20">
              <div className="max-md:flex flex-col justify-center items-center md:mt-7">
                ...
                <button className="px-4 py-2 bg-linear-to-r from-primary to-secondry rounded-full text-white md:mt-20 ml-6 md:scale-125 max-md:mt-4 max-md:mr-6 md:hover:scale-140 cursor-pointer font transition-all duration-300 font-semibold">Shop Now</button>
              </div>

            <div className="md:w-120 md:h-120 sm:h-95 md:ml-20">
              <img src={PS5} alt="Playstation 5" className="w-full h-full max-md:w-90 max-md:h-80 max-md:scale-90" />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="p-6 ">
          <div className="md:grid md:grid-cols-2 gap-20">
            ...
            <div className="md:w-100 md:h-80 sm:h-95 md:ml-20 mt-14">
              <img src={Speaker} alt="Playstation 5" className="w-full h-full max-md:w-80 max-md:h-60 max-md:scale-90 max-md:ml-8" />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="p-6 ">
          <div className="md:grid md:grid-cols-2 gap-20">
            ...
            <div className="md:w-120 md:h-90 sm:h-95  md:ml-20 mt-10 max-md:w-80 max-md:h-60 scale-110">
              <img src={Headphones} alt="Playstation 5" className="w-full h-full max-md:scale-100 max-md:ml-8" />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="p-6 ">
          <div className="md:grid md:grid-cols-2 gap-20">
            ...
            <div className="md:w-100 md:h-80 sm:h-95 md:ml-20 mt-12  md:scale-125 max-md:h-70 max-md:ml-5">
              <img src={TShirt} alt="Playstation 5" className="w-full h-full max-md:scale-80" />
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
